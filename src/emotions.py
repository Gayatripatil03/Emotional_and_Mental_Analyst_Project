        ...
        if(isexec):
            ...
            for (x, y, w, h) in faces:
                ...
                with sr.Microphone() as source2:
                    ...
                    ans = ans.lower()
                    print(""+ans)
                    sql="insert into uanswer (Answer,Cat,question)values(%s,%s,%s)"
                    values=(""+ans,""+emotion_dict[maxindex],mytext)
            ...
            for x1 in myresult:
                ...
                s1 = x1[1].lower()
                s1List = s1.split(" ")
                uscore=len(list(set(s0List)&set(s1List)))
                recomqueno.append(c1)
                recomque.append(x1[2])
                score.append(uscore)
                c1=c1+1
            scoremax=max(score)
            queask=recomque[scoremax]
            print(queask)
            ...
            if(score==0):
                ...
                randfile = str(r2)+"randomtext"+str(r1) +".mp3"
                lan='en'
                a1=gTTS(text=queask,lang=lan,slow=False)
                a1.save(randfile)
                playsound(randfile)
                with sr.Microphone() as source2:
                    r.adjust_for_ambient_noise(source2, duration=0.2)
